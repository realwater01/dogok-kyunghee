            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6 text-text-light leading-relaxed">
                <p>
                  ...
                  과정에서 겪는 일시적인 어려움일 수도, 오래 이어지는 어려움일
                  수도 있습니다. 다만 치료의 목표를 분명히 하지 않은 채 당장의
                  증상 조절에만 오래 의존하면,
                  아이가 편해지는 듯해도 성장기의 어려움이 성인기의
                  우울·불안·강박으로 이어지거나, 적절한 치료 시기를 놓칠 수도
                  있습니다.
                </p>
                <p>
                  그래서 도곡경희한의원의 아이 치료는 무조건적인 원인 치료를
                  주장하지 않습니다. 아이의 현재 질병 상태와 유전·환경적 요인을
                  함께 고려해, 아이의 성장 과정과 앞으로의 성인기 삶에 가장 유익한
                  방향으로 치료를 결정합니다.
                </p>
                <p>
                  한약은 쉽게 흥분하는 자율신경계를 안정시키고 아이의 뇌가
                  건강하게 발달하도록 도와, 과잉 행동과 충동, 틱, 불안·강박 같은
                  증상이 조금씩 가라앉을 수 있는 바탕을 만들어 갑니다.
                </p>
                <p>
