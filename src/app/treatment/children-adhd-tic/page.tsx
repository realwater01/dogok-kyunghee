        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6 text-text-light leading-relaxed">
                <p>
                  틱, ADHD, 불안, 강박은 아이의 뇌가 자라며 시간이 지나면
                  자연스럽게 나아지는 경우도 있고, 오래 이어져 꾸준한 관리가
                  필요한 경우도 있습니다. 그래서 지금 우리 아이가 어느 쪽인지
                  정확히 살피고, 그에 맞는 치료 목표를 세우는 것이 무엇보다
                  중요합니다.
                </p>
                <p>
                  목표 없이 당장의 증상 조절에만 오래 의존하면, 아이가 편해지는
                  듯해도 성장기의 어려움이 성인기의 우울·불안·강박으로 이어지거나,
                  적절한 치료 시기를 놓칠 수 있습니다.
                </p>
                <p>
                  그래서 도곡경희한의원은 무조건적인 원인 치료를 주장하지
                  않습니다. 아이의 현재 상태와 유전·환경적 요인을 함께 살펴, 지금
                  치료가 필요한지 조금 더 지켜봐도 되는지까지 함께 판단하고, 성장
                  과정과 앞으로의 성인기 삶에 가장 유익한 방향으로 치료를
                  결정합니다.
                </p>
                <p>
                  아이가 성장 과정에서 행복할 수 있도록 돕고, 성인이 되어서도
                  우울·불안·강박으로 고통받지 않는 건강한 성인으로 자라도록 하는
                  데 치료의 목표를 둡니다.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="bg-cream p-8 rounded-xl">
              ...
              <p className="text-text-light leading-relaxed pl-6">
                증상의 정도와 아이의 상태에 따라 개인차가 큽니다. 일반적으로 3-6개월
                정도의 치료 기간을 권장하며, 상담을 통해 아이의 상태에 맞는 계획을
                안내해 드립니다. 호전이 나타나는 시점과 정도는 아이마다 다를 수 있습니다.
              </p>
            </div>
